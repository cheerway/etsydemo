...
class Admin::ListingsControllerTest < ActionController::TestCase
  ...
  test "should create admin_listing" do
    assert_difference('Admin::Listing.count') do
      post :create, admin_listing: { description: @admin_listing.description, name: @admin_listing.name, price: @admin_listing.price, stock: @admin_listing.stock }
    end
  ...
  test "should update admin_listing" do
    patch :update, id: @admin_listing, admin_listing: { description: @admin_listing.description, name: @admin_listing.name, price: @admin_listing.price, stock: @admin_listing.stock }
    assert_redirected_to admin_listing_path(assigns(:admin_listing))
  end
