...
class Admin::OrdersControllerTest < ActionController::TestCase
  ...
  test "should create admin_order" do
    assert_difference('Admin::Order.count') do
      post :create, admin_order: { address: @admin_order.address, name: @admin_order.name, payment_method: @admin_order.payment_method, status: @admin_order.status }
    end
  ...
  test "should update admin_order" do
    patch :update, id: @admin_order, admin_order: { address: @admin_order.address, name: @admin_order.name, payment_method: @admin_order.payment_method, status: @admin_order.status }
    assert_redirected_to admin_order_path(assigns(:admin_order))
  end
